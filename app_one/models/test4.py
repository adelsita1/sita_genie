...
class PDFQuestionAnswerer:
    ...
    def find_similar_question(self, question: str, similarity_threshold: float = 0.5) -> Tuple[str, str, float]:
...
def main():
    ...
    openai_api_key = "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"
    excel_path = "qa_database.xlsx"

    os.environ["OPENAI_API_KEY"] = openai_api_key

    qa_system = PDFQuestionAnswerer(pdf_path, openai_api_key, excel_path)
